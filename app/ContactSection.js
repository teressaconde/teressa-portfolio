    ...
    <section id="contact" className="py-20 px-8 md:px-32">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
          ...
          >
            <span className="mb-4 text-3xl text-[var(--accent)] group-hover:scale-110 transition-transform">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-10 h-10"><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h.75a2.25 2.25 0 002.25-2.25v-2.25a2.25 2.25 0 00-2.25-2.25h-1.125a1.125 1.125 0 01-1.125-1.125v-1.5a1.125 1.125 0 011.125-1.125H21a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0021 4.5h-15A2.25 2.25 0 003.75 6.75v.243a2.25 2.25 0 01-.659 1.591l-7.091 7.091a2.25 2.25 0 01-3.182 0L3.409 8.584A2.25 2.25 0 012.75 6.993V6.75" /></svg>
            </span>
            <p className="text-lg font-semibold mb-2 text-white light:text-black">+639063323183</p>
          </a>
          {/* Location Card */}
          <a
          ...
          >
            <span className="mb-4 text-3xl text-[var(--accent)] group-hover:scale-110 transition-transform">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-10 h-10"><path strokeLinecap="round" strokeLinejoin="round" d="M12 21.75c-4.97-4.97-7.5-8.25-7.5-11.25A7.5 7.5 0 0112 3a7.5 7.5 0 017.5 7.5c0 3-2.53 6.28-7.5 11.25z" /><circle cx="12" cy="10.5" r="2.5" /></svg>
            </span>
            <p className="text-lg font-semibold mb-2 text-white light:text-black">Davao City, Philippines</p>
          </a>
        </div>
      </div>
    </section>
